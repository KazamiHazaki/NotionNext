const CONFIG = {
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/KazamiHazaki',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://blog.abdulazizm.my.id/',
  ...
  // 底部统计面板文案
  // Footer statistics panel labels
  HEO_POST_COUNT_TITLE: 'Posts:',
  HEO_SITE_TIME_TITLE: 'Site Days:',
