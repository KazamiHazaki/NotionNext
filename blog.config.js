...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'samuraixheart', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A food lover — the kind who can deploy servers too🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.abdulazizm.my.id', // 网站地址
